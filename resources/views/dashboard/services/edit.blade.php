...
@section('description')
    <meta name="description" content="website services edit page in the dashboard">
@endsection
                        ...
                        <div class="card-body">
                          <div class="d-flex flex-row justify-content-center align-items-center my-3"
                              ...
                              <h5 class="text-center  bg-secondary rounded text-white m-0 "
                                  ...
                                  Services Section In The Home Page </h5>
                            ...
                            @include('components.dashboard.services.form' , [
                              'formUrl' => route('dashboard.services.update', $service->id),
                              'method' => 'PATCH',
                            ])
                        </div>
                    </div>
