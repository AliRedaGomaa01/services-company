...
@section('description')
    <meta name="description" content="website sliders edit page in the dashboard">
@endsection
                        ...
                        <div class="card-body">
                          <div class="d-flex flex-row justify-content-center align-items-center my-3"
                              ...
                              <h5 class="text-center  bg-secondary rounded text-white m-0 "
                                  ...
                                  Sliders Section In The Home Page </h5>
                            ...
                            @include('components.dashboard.sliders.form' , [
                              'formUrl' => route('dashboard.sliders.update', $slider->id),
                              'method' => 'PATCH',
                            ])
                        </div>
                    </div>
