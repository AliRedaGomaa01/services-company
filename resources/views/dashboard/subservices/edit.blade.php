...
@section('description')
    <meta name="description" content="website subservices edit page in the dashboard">
@endsection

@section('title', 'Subservice Edit')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">Edit Subservice</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-row justify-content-center align-items-center my-3" style="gap : 1rem">
                                <h5 class="text-center  bg-secondary rounded text-white m-0 " style="padding:1.5rem">
                                    Subservices Section In The Home Page </h5>
                            ...
                            @include('components.dashboard.subservices.form', [
                                'formUrl' => route('dashboard.subservices.update', $subservice->id),
                                'method' => 'PATCH',
                            ])
                        </div>
                    </div>
