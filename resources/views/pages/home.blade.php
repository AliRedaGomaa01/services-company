...
@section('content')
      ...
      <div id="bootcarousel" class="carousel slide carousel-fade animate_text" data-ride="carousel">
          ...
          <div class="carousel-inner text-light carousel-zoom">
              <div class="item active">
                  <div class="slider-thumb bg-cover" style="background-image: url(/frontend-assets/img/banner/2.jpg);"></div>
              ...
              <div class="item">
                  <div class="slider-thumb bg-cover" style="background-image: url(/frontend-assets/img/banner/3.jpg);"></div>
                  <div class="box-table shadow dark">
                      <div class="box-cell">
                          <div class="container">
                              <div class="row">
              ...
              <div class="item">
                  <div class="slider-thumb bg-cover" style="background-image: url(/frontend-assets/img/banner/21.jpg);"></div>
                  <div class="box-table shadow dark">
                      <div class="box-cell">
                          <div class="container">
                              <div class="row">
              ...
              <div class="col-md-6 info-content">
                  ...
                  <div class="author">
                      ...
                      <div class="info">
                          ...
                          <img src="/frontend-assets/img/signature.png" alt="signature">
                      </div>
                  </div>
              </div>
  ...
  <div class="choseus-area about-area bg-gray">
      <div class="container-full">
          <div class="row">
              <div class="content-box">
                  <div class="col-md-6 thumb bg-cover" style="background-image: url(/frontend-assets/img/banner/1.jpg);"></div>
                      ...
                      <div id="portfolio-grid" class="portfolio-items col-3">
                          <div class="portfolio-items">
                              ...
                              <div class="pf-item petroleum industry">
                                  <div class="effect-up">
                                      <img src="/frontend-assets/img/portfolio/7.jpg" alt="Thumb">
                                      <div class="overlay">
                                          <h4>Mechanical Engineering</h4>
                                          <div class="link">
                                              <a href="/frontend-assets/img/portfolio/7.jpg" class="item popup-link"><i class="fa fa-search"></i></a>
                                              <a href="#"><i class="fas fa-link"></i></a>
                                          </div>
                                      </div>           
                                  </div>
  ...
  <!-- Start Achivement
  ============================================= -->
  <div class="achivement-area bg-fixed shadow dark text-light" style="background-image: url(/frontend-assets/img/banner/5.jpg);">
      <div class="container">
          <div class="row">
              ...
              <div class="blog-items">
                      ...
                      <div class="single-item">
                          <div class="thumb">
                              <a href="blog-single-right-sidebar.html">
                                  <img src="/frontend-assets/img/blog/1.jpg" alt="Thumb">
                              </a>
                              <div class="author">
                                  <div class="thumb">
                          ...
                          <div class="info">
                              <h4>
                                  <a href="blog-single-right-sidebar.html">Longer mrs sudden talent become</a>
                              </h4>
                              <p>
                              ...
                              <a href="blog-single-right-sidebar.html">Read More <i class="fas fa-arrow-right"></i></a>
                          </div>
                      </div>
                  </div>
                  <!-- Single Item -->
                  ...
                  <div class="col-md-4">
                      <div class="single-item">
                          <div class="thumb">
                              <a href="blog-single-right-sidebar.html">
                                  <img src="/frontend-assets/img/blog/2.jpg" alt="Thumb">
                              </a>
                              <div class="author">
                                  <div class="thumb">
                                      <img src="/frontend-assets/img/team/4.jpg" alt="Author">
                                  </div>
                                  <div class="meta">
                                      <h5>Admin</h5>
                          ...
                          <div class="info">
                              <h4>
                                  <a href="blog-single-right-sidebar.html">Conduct esteems cottage pasture we winding</a>
                              </h4>
                              <p>
                                  On assistance he cultivated considered frequently. Person how having tended direct own day man. Saw sufficient indulgence one own you inquietude sympathize. 
                              </p>
                  ...
                  <div class="col-md-4">
                      <div class="single-item">
                          <div class="thumb">
                              <a href="blog-single-right-sidebar.html">
                                  <img src="/frontend-assets/img/blog/3.jpg" alt="Thumb">
                              </a>
                              <div class="author">
                                  <div class="thumb">
                          ...
                          <div class="info">
                              <h4>
                                  <a href="blog-single-right-sidebar.html">Considered discovered projecting</a>
                              </h4>
                              <p>
                                  On assistance he cultivated considered frequently. Person how having tended direct own day man. Saw sufficient indulgence one own you inquietude sympathize. 
                              </p>
